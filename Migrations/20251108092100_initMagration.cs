    ...
    public partial class initMagration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_customrs", x => x.CustomerID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_customrs_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "customrs",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_paymentInformation_customrs_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "customrs",
                        principalColumn: "CustomerID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_shippingAddresses_customrs_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "customrs",
                        principalColumn: "CustomerID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_reviews_customrs_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "customrs",
                        principalColumn: "CustomerID",
                        onDelete: ReferentialAction.Cascade);
